...
def get_Y_from_examples(mapping, examples):
    row_indices = []
    col_indices = []
...
if __name__ == '__main__':
    ...
    examples_generator = DataStreamer.load_from_bz2(args.examples_bz2)

    Y = get_Y_from_examples(mapping, examples_generator)
